...
!(function (t, n) {
    ...
    let Ua = class {
        ...
        bezierCurveTo(t, n, e, r, i, o) {
            this._append`C${+t},${+n},${+e},${+r},${(this._x1 =
                +i)},${(this._y1 = +o)}`;
        }
        arcTo(t, n, e, r, i) {
            ...
            if (null === this._x1)
                ...
                if (Math.abs(s * u - c * f) > Ra && i) {
                    ...
                    Math.abs(b - 1) > Ra &&
                        ...
                        this._append`A${i},${i},0,0,${+(
                            s * h >
                            f * d
                        )},${(this._x1 = t + m * u)},${(this._y1 = n + m * c)}`;
                ...
                e &&
                    ...
                    l > Fa
                        ? this._append`A${e},${e},0,1,${s},${t - a},${
                              n - u
                          }A${e},${e},0,1,${s},${(this._x1 = c)},${(this._y1 =
                              f)}`
                        : l > Ra &&
                          this._append`A${e},${e},0,${+(
                              l >= $a
                          )},${s},${(this._x1 =
                              t + e * Math.cos(i))},${(this._y1 =
                              n + e * Math.sin(i))}`);
        }
        rect(t, n, e, r) {
            this._append`M${(this._x0 = this._x1 = +t)},${(this._y0 = this._y1 =
        ...
        arc(t, n, e) {
            ...
            null === this._x1
                ...
                e &&
                    (this._ += `A${e},${e},0,1,1,${
                        t - e
                    },${n}A${e},${e},0,1,1,${(this._x1 = r)},${(this._y1 =
                        i)}`);
        }
        rect(t, n, e, r) {
            this._ += `M${(this._x0 = this._x1 = +t)},${(this._y0 = this._y1 =
    ...
    function t_(t, n) {
        return (
            (t = Jv(t)), _v(Ay.count(tv(t), t) + (4 === tv(t).getDay()), n, 2)
        );
    }
    function n_(t) {
        return t.getDay();
